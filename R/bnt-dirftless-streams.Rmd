...
join sites to nearest classified stream to get a site's stream class (so sites that are not on or near a classified stream get an NA for stream class:
...
ggplot() + 
  ...
  labs(
    ...
    subtitle ="Percent of classified streams with trout present:",
