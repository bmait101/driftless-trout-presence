...
(percent.wbics.bnt.123 <- round((n.wbics.bnt.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))
...
(percent.wbics.bkt.123 <- round((n.wbics.bkt.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))
...
(percent.wbics.tgt.123 <- round((n.wbics.tgt.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))
...
(percent.wbics.smp.123 <- round((n.wbics.smp.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))
(percent.wbics.smp.12 <- round((n.wbics.smp.12/n.surveyed.wbics.class12) * 100, digits = 2))

(percent.wbics.bkt.only <- round((n.wbics.bkt.only.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))

(percent.wbics.bnt.only <- round((n.wbics.bnt.only.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))

(percent.wbics.notrout <- round((n.wbics.notrout.123/n.surveyed.wbics.fish.class123) * 100, digits = 2))
