...
Must make a presence-absence matrix. Assuming zeros where not present. 
...
(percent.wbics.bnt.present <- round((n.wbics.bnt.p.12/n.wbics.classed12.surveyed) * 100, digits = 2))
```

```{r}
(percent.wbics.bkt.present <- round((n.wbics.bkt.p/n.wbics.classed.surveyed) * 100, digits = 2))
(percent.wbics.bkt.present <- round((n.wbics.bkt.p.12/n.wbics.classed12.surveyed) * 100, digits = 2))
```

```{r}
(percent.wbics.bkt.present <- round((n.wbics.tiger.p/n.wbics.classed.surveyed) * 100, digits = 2))
(percent.wbics.bkt.present <- round((n.wbics.tiger.p.12/n.wbics.classed12.surveyed) * 100, digits = 2))
```
