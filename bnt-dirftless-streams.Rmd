...
In the Driftless Ecoregion of Wisconsin, `r percent.wbics.w.bnt`% of surveyed wbics have Brown Trout present, while `r percent.wbics24k.w.bnt`% of *all* wbics present in the 24k Hydro Geodatabase have Brown Trout present.  **NOTE:** Result is based on survey data collected from 1994-2020 by Fisheries Management. 